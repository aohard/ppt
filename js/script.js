function magnify(imgID, zoom) {
    ...
    function showDescription(xPercent, yPercent) {
        ...
        } else if (xPercent > 60 && xPercent < 100 && yPercent > 0 && yPercent < 20) {
        ...
        } else if (xPercent > 40 && xPercent < 100 && yPercent > 21 && yPercent < 50) {
        ...
        } else if (xPercent > 40 && xPercent < 100 && yPercent > 70 && yPercent < 80) {
            document.getElementById("description6").style.display = "block";
        } else if (xPercent > 0 && xPercent < 100 && yPercent > 80 && yPercent < 101) {
